    ...
    <div className="mt-20 mx-auto px-4 md:mt-28">
      <div className="text-center md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto">
        ...
        <div className="flex  md:flex-row mt-7 lg:mt-10 items-center justify-center gap-4 md:gap-6">
          <button className="bg-[#5CB8E4] border-2 border-transparent rounded-3xl text-xl text-white px-4 py-2 hover:bg-blue-500 hover:border-[#5CB8E4] transition-colors duration-200 ease-in-out lg:text-2xl lg:px-8 lg:py-4">Learn More</button>
          <button className="bg-[#5CB8E4] border-2 border-transparent rounded-3xl text-xl text-white px-4 py-2 hover:bg-blue-500 hover:border-[#5CB8E4] transition-colors duration-200 ease-in-out lg:text-2xl lg:px-8 lg:py-4">Get Started</button>
        </div>
        <FeatureSection/>
        <MiniFeatureSection />
      </div>
